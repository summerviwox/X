...
public class XFragment2<A extends UI,B extends DE,C extends VA> extends Fragment implements View.OnClickListener {

    private Ope<A,B,C> ope;

    private XActivity activity;

    private XFragment2 fragment;
