...
import com.summer.x.base.ui.Ope;
...
public class XActivity2<A extends UI,B extends DE,C extends VA> extends FragmentActivity implements View.OnClickListener {

    private Ope<A,B,C> ope;

    private XActivity2 activity;
